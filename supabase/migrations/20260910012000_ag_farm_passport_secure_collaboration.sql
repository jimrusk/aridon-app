...
-- Production migration applied 2026-09-09. Customer access is brokered by authenticated
-- server routes. External reviewer access uses random tokens stored only as SHA-256 hashes.
