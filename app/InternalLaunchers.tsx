...
export default function InternalLaunchers() {
  ...
  return (
    ...
    >
      ...
      <Link href="/local-growth" aria-label="Open Aridon Local Growth OS" style={{ ...launcherStyle, background: '#9EF0CF' }}>◎ Local Growth</Link>
      ...
      <Link href="/executive-ops/control-center" aria-label="Open Executive Operations control center" style={{ ...launcherStyle, background: '#A8D8FF' }}>⚡ Exec Ops</Link>
