...
export default function AgFinancePage() {
  return <>
    ...
    <div style={{ position:'fixed', left:16, bottom:16, zIndex:40, display:'flex', gap:10, flexWrap:'wrap' }}>
      ...
      <Link href="/ag/finance/farm-ownership" style={{ background:'#F4D06F', color:'#17301E', textDecoration:'none', borderRadius:999, padding:'12px 16px', fontWeight:950, boxShadow:'0 12px 30px rgba(0,0,0,.24)' }}>Farm Ownership Pathway</Link>
    </div>
  </>;
}
